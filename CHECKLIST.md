...
Tick these in order. The first three are blockers.
...
- [ ] `fermahatlas.xyz/c/eam__sha` posted in a private X draft — the card unfurls
- [ ] X account @fermah_atlas: avatar `brand/atlas-avatar-1000.png`, banner `brand/x-banner.png`, bio set
- [ ] A moderator told, before anything public
- [ ] Ten creators sent their own link
- [ ] Pinned tweet posted
